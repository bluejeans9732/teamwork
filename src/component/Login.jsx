...
function Login() {
    return (
        <div className="h-full w-full relative overflow-y-scroll scrollbar-hide flex">
            <div className="flex w-3/6"><img src="./image/carfix.jpg" className="" /></div>
            <div className=" pt-20 pl-20 mx-auto w-3/6 bg-gray-50">
                ...
                <div className="flex flex-col mt-40 mx-auto w-1/2">
                    ...
                    <p className="mt-3 text-xs">회원정보를 입력해주세요.</p>
                    <p className="mt-10">이메일 주소</p>
                    <input type="email" 
                        className="rounded-md  mt-1 border-2 border-slate-300 w-full h-10 outline-none focus:bg-cyan-50 placeholder:pl-3"
                    />
                    <p className="mt-3">비밀번호</p>
                    <input type="text"
                        className="rounded-md  mt-1 border-2 border-slate-300 w-full h-10 outline-none placeholder:pl-3"
                    />
                    <div>
                        <p className="mt-1 text-xs float-right">비밀번호를 잊어버렸나요?</p>
                    </div>
                    ...
                    <div className="mx-auto mt-20">아직 계정이 없다면?<Link to="/pwid" className="ml-3 underline underline-offset-2">회원가입</Link></div>
                </div>
            </div>
